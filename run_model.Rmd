...
p_total <- total_averted %>% 
    ...
    labs(x = "Antiviral effectiveness", y = "Averted number of hospitalizations relative to worst-case")
...
change.worst %>% filter(age != "all") %>%
    ...
    labs(x = "Age (years)", y = "Averted number of hospitalizations relative to worst-case")
...
change.perc.worst %>% filter(age != "all") %>%
    ...
    scale_color_manual("Risk", values = cols_risk) +
    labs(x = "Age (years)", y = "Averted percent of hospitalizations relative to worst-case")
...
p_alt_num <- 
    ...
    mutate(age_names = factor(age_labels[match(age, age.grps)], levels = age_labels)) %>%
    ...
    facet_grid(~ age_names) + get_theme(txt = 9, legend.position = "top") + 
    scale_y_log10(labels = comma) +
    scale_color_manual(NULL, values = cols_alt) +
    labs(x = "Risk stratification", y = "Averted number of hospitalizations\nrelative to worst-case")
...
p_alt_perc <- 
    ...
    labs(x = "Risk stratification", y = "Averted percent of hospitalizations\nrelative to worst-case")
...
ggsave(here("figs", "fig4.png"), width = 8, height = 9, dpi = 600)
...
p_alt2_num <- 
    ...
    labs(x = "", y = "Averted number of hospitalizations\nrelative to worst-case")
...
p_alt2_perc <- 
    ...
    labs(x = "", y = "Averted percent of hospitalizations\nrelative to worst-case")
...
ggsave(here("figs", "figS5.png"), width = 8, height = 9)
```
...
ggsave(here("figs", "figS6.png"), width = 8, height = 9)
```

```{r}
# Across all age groups / risk stratifications: numbers for text
