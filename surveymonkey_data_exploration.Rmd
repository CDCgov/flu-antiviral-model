...
flu_sm <- survey_monkey %>% select(contains("flu"), contains("influenza"), contains("ST"), contains("age"), contains("date"), contains("professional"), contains("cold"), contains("testing"), contains("symptom"), contains("condition"), contains("antiviral"), -contains("covid"),  -contains("c19"))
